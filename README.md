...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/docling-core-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/docling-core-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add docling-core
# for installing globally
pixi global install docling-core
```
...
It is possible to list all of the versions of `docling-core` available on your platform:
...
```
pixi search docling-core --channel conda-forge
```
